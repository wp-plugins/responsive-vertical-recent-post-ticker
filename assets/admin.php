...
printf(
            '<input type="text" id="ticker_cat" name="vertical_ticker_option[ticker_cat]" value="%s" />',
    ...
    {
        printf(
            '<input type="text" id="thmb_height" name="vertical_ticker_option[thmb_height]" value="%s" />',
    ...
    {
        printf(
            '<input type="text" id="thmb_width" name="vertical_ticker_option[thmb_width]" value="%s" />',
    ...
    {
        printf(
            '<input type="text" id="thmb_border" name="vertical_ticker_option[thmb_border]" value="%s" />',
    ...
    {
        printf(
            '<input type="text"  id="ticker_title_size" name="vertical_ticker_option[ticker_title_size]" value="%s" />',
    ...
    {
        printf(
            '<input type="text"  id="ticker_text_size" name="vertical_ticker_option[ticker_text_size]" value="%s" />',
